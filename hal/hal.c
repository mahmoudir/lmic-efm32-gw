...
//	#define PIN_DIO5			0
	#define PORT_DIO0			gpioPortC	//DIO0 = PC0
	#define PIN_DIO0			0
	#define PORT_DIO1			gpioPortC	//DIO1 = PC3
	#define PIN_DIO1			3
	#define PORT_DIO2			gpioPortC	//DIO2 = PC0
	#define PIN_DIO2			4
	#define PORT_DIO3			gpioPortC	//DIO3 = PC5
	#define PIN_DIO3			5
	#define PORT_DIO4			gpioPortC	//DIO4 = PC6
	#define PIN_DIO4			3
	#define PORT_DIO5			gpioPortC	//DIO5 = PC7
	#define PIN_DIO5			4
